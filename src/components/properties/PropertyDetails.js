...
var addComment = <></>;
  ...
  if (props.getTheUser) {
    addComment = (
      <>
        <ReactStars {...ownRating} / > <form onSubmit={handleComment} className="d-flex mt-2">
    ...
    data-date-format="DD MMMM YYYY"/> < /div>
              </div > <div className="col-40">
    <div className="form-group">
...
</div> < div className = "col-20" > <button type="submit" className="kokomo-btn-form">
    <SearchIcon/>
</button> < /div>
            </div > </form> < /div>
  ...
  if (state.actualRating) {
    ratingProperty = (
      <div className="d-flex">
        <ReactStars {...actualRating} / > <p className="text-review">
