...
const PropertyDetails = (props) => {
    ...
    const handleSubmit = (event) => {
        ...
        axios
            .post("http://localhost:5000/api/search/property/" + props.match.params.propertyId, body, {withCredentials: true})
            .then((response) => {
    ...
    if (props.getTheUser) {
        showProperty = (
          ...
          <form className="form-row mb-5" onSubmit={handleSubmit}>
              ...
              <input type="submit" value="Ver disponibildad" className="kokomo-btn-form p-3"/>
          </form>
      </div>
...
return (    <div
        ...
        <div className="white-card">
            ...
            <Tabs
                ...
                <Tab eventKey="nav-comments" title="Comentarios" className="nav-item nav-link">
                    <div class="row">
                        <div class="col-md-6">
                ...
                <Tab eventKey="nav-openings" title="Horarios" className="nav-item nav-link">
                    ...
                    <p>
                        Hora de apertura:{" "} {state.property.openingHours[0].openingTimes[0].openingTime}
                    </p>
                    <p>
                        Hora de cierre:{" "} {state.property.openingHours[0].openingTimes[0].closingTime}
                    </p>
