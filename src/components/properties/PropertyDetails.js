    ...
    showProperty = (
      <>
        <div className="row d-flex align-items-center justify-content-center">
          ...
          <button onClick={() => showForm()} className="btn-floating">Hacer una reserva</button>
        </div>
      </>
    );
    ...
    ratingProperty = (
      <div className="d-flex">
        ...
        <p className="text-review">
          ...
          {state.property.rating.counter.length === 1 ? "reseña" : "reseñas"}
        </p>
      </div>
    );
  }
    ...
    showMobileForm = (
      ...
      <div className="text-center d-flex align-items-center justify-content-center kokomo-popup">
        <div className="row align-middle justify-content-center w-100">
          ...
          <a onClick={hideForm} className="close-btn"><i className="fas fa-times"></i></a>
