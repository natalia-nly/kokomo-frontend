...
const AvailablePlaces = (props) => {
    ...
    const handleSubmit = (event) => {
        ...
        axios
            .post("http://localhost:5000/api/booking/create-booking/" + params.scheduleId, body, {withCredentials: true})
            .then((response) => {
                ...
                (
                    <div className="one-property" key={index}>
                        ...
                        <div className="search-pc">
                            ...
                            <p className="mdi mdi-map-marker-radius">{result.property.location.name}</p>
                                ...
                                {result
                                    ...
                                    .map((timebox) => (
                                        <form onSubmit={handleSubmit}>
                                            ...
                                            <input type="submit" className="kokomo-hours" value={timebox.startTime}/>
                                        </form>
                                    ))}
                            </div>
                        </div>
