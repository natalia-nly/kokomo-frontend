...
const Search = (props) => {
    ...
    axios
      ...
      .then((response) => {
        ...
        axios
            .post("http://localhost:5000/api/search/getAvailability", body, {withCredentials: true})
            .then((response) => {
    ...
    const getInfoWindowString = (place) => {
        ...
        return `
    <div>
    <a href="http://localhost:3000/property/${place
  ...
  return (
    <div>
        ...
        <div className="body-container">
            ...
            <div>
              <AvailablePlaces results={state.availableResults}/>
            </div>
        </div>
    </div>
);
